...
- **License**: GPL-3.0 / MIT.
- **Source Code**: [GitHub Repository](https://github.com/DrakesCraft-Labs/GlobalWarming)
- **Support & Issues**: [GitHub Issues](https://github.com/DrakesCraft-Labs/GlobalWarming/issues) | [Discord](https://discord.gg/rR7FbfCt9Y)
